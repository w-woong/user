...
type UserRepo interface {
	...
	ReadUserByID(ctx context.Context, tx common.TxController, ID string) (entity.User, error)
	ReadUserByIDNoTx(ctx context.Context, ID string) (entity.User, error)

	// ReadUserByLoginID reads user by loginID.
	ReadUserByLoginID(ctx context.Context, tx common.TxController, loginID string) (entity.User, error)
	...
	DeleteUserByID(ctx context.Context, tx common.TxController, ID string) (int64, error)
}
