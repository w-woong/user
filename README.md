...
```bash
curl -X GET http://localhost:49007/v1/user/85bf6aeb-459c-445a-be1e-0b67b8c100ef
...
http://localhost:49007/v1/user/17345530-53ea-4c27-8f0c-dcd96f8a4a9d
...
http://localhost:49007/v1/user/register
